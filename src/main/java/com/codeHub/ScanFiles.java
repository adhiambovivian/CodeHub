...
public class ScanFiles {
    public static void scanDirectories(){
        ...
        ThreadPoolExecutor excutorService=new ThreadPoolExecutor(maxThreads,maxThreads,waiting,
                TimeUnit.MINUTES,new ArrayBlockingQueue<Runnable>(maxThreads,true),new ThreadPoolExecutor.CallerRunsPolicy());
