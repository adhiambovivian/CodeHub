...
public class CoderService {
    ...
    public static void compareStringConcatPerformance() {
        ...
        System.out.println(
                "TT by concat with StringBuffer: " + (System.currentTimeMillis() - startTime));

        startTime = System.currentTimeMillis();
        concatWithStringBuilder();
        System.out.println(
                "TT by concat with StringBuilder: " + (System.currentTimeMillis() - startTime));
    }
    ...
    public static void patternMatching() {
        ...
        System.out.println(
                Pattern.matches(
                        "[amn]*", "ammmmnna")); // true (a or m or n may come zero or more times
