...
public class FileService {
    ...
    public static void sequenceReaderVectors() {
        try {
            ...
            fn5.close();
            System.out.println(
                    "Finitooooo. TT by vectors: " + (System.currentTimeMillis() - start));
        } catch (IOException e) {
            System.out.println("IO Error: " + e.getMessage());
        }
    }
    ...
    public static void byteArrayInputputStreamFromFile() {
        try {
            ...
            while ((data = byteArrayInputStream.read()) != -1) {
                char ch = (char) data;
                System.out.println(
                        "ASCII value of char is: " + data + " the special char is " + ch);
            }
    ...
    public static void filterInputStreamReader() {
        try {
            ...
            System.out.println(
                    "TT buffered FilterInputstream: " + (System.currentTimeMillis() - start));
    ...
    public static void fileWriterReaderBufferMethod() {
        try {
            ...
            System.out.println(
                    "TT buffered Filewriter & reader: " + (System.currentTimeMillis() - start));
        } catch (IOException e) {
            System.out.println("sth went wrong " + e.getMessage());
        }
    }
    ...
    public static void inputStreamReaderMethod() {
        try {
            ...
            writer.close();
            System.out.println(
                    "TT by streamReader & stream writer: " + (System.currentTimeMillis() - start));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public static void writeRandomAccess(String path, String data, int position)
            throws IOException {
    ...
    public static void deserialization() {
        try {
            ObjectInputStream objectInputStream =
                    new ObjectInputStream(new FileInputStream(filePath + "objects.txt"));
    ...
    public static void readDataFiles() {
        try {
            ...
            int data = 0;
            while ((data = bufferedReader.read()) != -1) System.out.print((char) data);
            bufferedReader.close();
            inputStream.close();
    ...
    public static void gatherBytes() {
        ...
        try {
            ...
            buffer1.asCharBuffer()
                    .put("Wow Wow weeu weeeeu asgsgsgajauwuuwnsn shhshsuuwuwu shbxbuss");
    ...
    public static void combineFiles() {
        try {
            String[] filePaths =
                    new String[] {
                        filePath + "test.txt",
                        filePath + "test copy 2.txt",
                        filePath + "test copy 3.txt",
                        filePath + "test copy 4.txt"
                    };
    ...
    public static void charsetChannel() {
        try {
            ...
            for (Map.Entry<String, Charset> entry : charsetMap.entrySet()) {
                ...
                System.out.println(
                        "Name: " + charset.displayName() + " Encoding: " + charset.canEncode());
                String data =
                        "Welcome to this place. it is wonderful and thrilling at the same time.";
