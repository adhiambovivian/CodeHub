...
public class DateService {
    ...
    public static void localDatetimeCmd() {
        ...
        stringBuilder
                .append("Day of week: " + now.get(ChronoField.DAY_OF_WEEK))
                .append(" Day of year: " + now.get(ChronoField.DAY_OF_YEAR))
                .append(" Day of month " + now.get(ChronoField.DAY_OF_MONTH))
                .append(" Hour of day " + now.get(ChronoField.HOUR_OF_DAY))
                .append(" Minute of day " + now.get(ChronoField.MINUTE_OF_DAY));
        System.out.println(
    ...
    public static void offsetTimeCmd() {
        ...
        st.append("Now: " + offsetTime + " Hr of day: " + offsetTime.get(ChronoField.HOUR_OF_DAY))
                .append(" Min of day: " + offsetTime.get(ChronoField.MINUTE_OF_DAY))
                .append(" Sec of day: " + offsetTime.get(ChronoField.SECOND_OF_DAY))
                .append(" Current hr: " + offsetTime.getHour())
                .append(" Offset minus 34 hrs: " + offsetTime.minusHours(34));
    ...
    public static void offsetDateTimeCmd() {
        ...
        st.append(
                        "Date: "
                                ...
                                + " Day of week: "
                                + off.getDayOfWeek())
                .append(" Minus 100 months: " + off.minusMonths(100))
    ...
    public static void clockCmd() {
        ...
        System.out.println(
                "Current zone: "
                        ...
                        + " +duration: "
                        + Clock.offset(Clock.systemUTC(), duration).instant());
    }
    ...
    public static void zonedDateTimeCmd() {
        ...
        System.out.println(
                "Parse zone: "
                        ...
                        + currentZone
                        + " minus 100 days: "
                        + currentZone.minus(Period.ofDays(120)));
    }
    ...
    public static void zonedIdCmd() {
        ...
        System.out.println(
                zoneId.getDisplayName(TextStyle.FULL, Locale.ROOT)
                        + "   "
    ...
    public static void zoneOffsetCmd() {
        ...
        System.out.println(
                temporal
                        ...
                        + " Zone supported: "
                        + ZoneOffset.UTC.isSupported(ChronoField.OFFSET_SECONDS));
    }
    ...
    public static void yearMonthCmd() {
        ...
        System.out.println(
                "Current YearMonth: "
                        ...
                        + " Comparison: "
                        + yearMonth.minus(Period.ofYears(1837))
                        + " Formatted date: "
                        + formattedYearMonth);
    }
    ...
    public static void instantCmd() {
        ...
        System.out.println(
                "Some future date: "
                        + instant.plus(Duration.ofDays(8928))
                        + " is Years supported: "
                        + instant.isSupported(ChronoUnit.YEARS)
                        + " current time: "
                        + Instant.now());
    }
    ...
    public static void monthCmd() {
        ...
        System.out.println(
                "Month: " + month1 + " Days: " + month1.length(true) + " Name: " + month1.name());
    }
    ...
    public static void dateformatCmd() {
        ...
        System.out.println(
                "Date format using getInstance(): " + DateFormat.getInstance().format(currentDate));
        System.out.println(
                "Date format using getDateInstance(): "
                        + DateFormat.getDateInstance().format(currentDate));
        System.out.println(
                "Date format using getTimeInstance(): "
                        + DateFormat.getTimeInstance().format(currentDate));
        System.out.println(
                "Date format using getDateTimeInstance(): "
                        + DateFormat.getDateTimeInstance().format(currentDate));
        System.out.println(
                "Date format using getTimeInstance(DateFormat.SHORT): "
                        + DateFormat.getTimeInstance(DateFormat.SHORT).format(currentDate));
        System.out.println(
                "Date format using getTimeInstance(DateFormat.MEDIUM): "
                        + DateFormat.getTimeInstance(DateFormat.MEDIUM).format(currentDate));
        System.out.println(
                "Date format using getTimeInstance(DateFormat.LONG): "
